...
describe('PeopleComponent', () => {
  ...
  it('should show relevant data', (() => {
    ...
    const hair: HTMLHeadingElement = fixture.nativeElement.querySelector('[data-cy="hair"]');
    const eye: HTMLHeadingElement = fixture.nativeElement.querySelector('[data-cy="eyes"]');
    const birth: HTMLHeadingElement = fixture.nativeElement.querySelector('[data-cy="birth"]');
    const gender: HTMLHeadingElement = fixture.nativeElement.querySelector('[data-cy="gender"]');
